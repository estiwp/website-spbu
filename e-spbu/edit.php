...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form4")) {
  $updateSQL = sprintf("UPDATE pencarian SET Lokasi=%s, Fasilitas=%s, `Jam Operasional`=%s, `Jenis Produk`=%s WHERE `No`=%s",
                       GetSQLValueString($_POST['Lokasi'], "text"),
                       GetSQLValueString($_POST['Fasilitas'], "text"),
                       GetSQLValueString($_POST['Jam_Operasional'], "text"),
                       GetSQLValueString($_POST['Jenis_Produk'], "text"),
...
$colname_edit = "-1";
if (isset($_GET['No'])) {
  $colname_edit = (get_magic_quotes_gpc()) ? $_GET['No'] : addslashes($_GET['No']);
}
mysql_select_db($database_koneksi, $koneksi);
$query_edit = sprintf("SELECT * FROM pencarian WHERE `No` = %s", $colname_edit);
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
      ...
      <tr valign="baseline">
        <td nowrap align="right">Lokasi:</td>
        <td><input type="text" name="Lokasi" value="<?php echo $row_tampil_adm['Lokasi']; ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Fasilitas:</td>
        <td><input type="text" name="Fasilitas" value="<?php echo $row_tampil_adm['Fasilitas']; ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Jam Operasional:</td>
        <td><input type="text" name="Jam_Operasional" value="<?php echo $row_tampil_adm['Jam Operasional']; ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Jenis Produk:</td>
        <td><input type="text" name="Jenis_Produk" value="<?php echo $row_tampil_adm['Jenis Produk']; ?>" size="32"></td>
      </tr>
      <tr valign="baseline">
    ...
    <input type="hidden" name="No" value="<?php echo $row_tampil_adm['No']; ?>">
  </form>
  <p>&nbsp;</p>
</div>
